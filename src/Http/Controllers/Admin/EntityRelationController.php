...
class EntityRelationController extends Controller
{
    ...
    {
        return view('crm::admin.entities.relations.index', [
            'entity' => $entity,
    ...
    {
        return view('crm::admin.entities.relations.form', $this->formData($entity));
    }
    ...
    public function edit(Entity $entity, EntityRelation $relation): View
    {
        ...
        return view('crm::admin.entities.relations.form', [
