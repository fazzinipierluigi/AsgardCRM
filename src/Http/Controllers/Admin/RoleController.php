...
use Fazzinipierluigi\AsgardCRM\Http\Requests\Admin\StoreRoleRequest;
use Fazzinipierluigi\AsgardCRM\Http\Requests\Admin\UpdateRolePermissionsRequest;
use Fazzinipierluigi\AsgardCRM\Http\Requests\Admin\UpdateRoleRequest;
...
class RoleController extends Controller
{
    ...
    {
        return view('crm::admin.roles.index');
    }
    ...
    {
        return view('crm::admin.roles.create');
    }
    ...
    public function edit(Role $role): View|RedirectResponse
    {
        ...
        return view('crm::admin.roles.edit', ['role' => $role]);
    }
    ...
    public function editPermissions(Role $role): View|RedirectResponse
    {
        ...
        return view('crm::admin.roles.permissions', [
            'role' => $role,
