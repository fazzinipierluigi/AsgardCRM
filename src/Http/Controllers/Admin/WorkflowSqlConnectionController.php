...
use Fazzinipierluigi\AsgardCRM\Http\Requests\Admin\WorkflowSqlConnectionRequest;
...
class WorkflowSqlConnectionController extends Controller
{
    ...
    {
        return view('crm::admin.workflow-sql-connections.index', [
    ...
    {
        return view('crm::admin.workflow-sql-connections.create', [
            'connection' => null,
    ...
    {
        return view('crm::admin.workflow-sql-connections.edit', [
