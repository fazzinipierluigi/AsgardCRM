...
class EntityChangeLogger
{
     ...
     */
    public function logCreated(Entity $entity, EntityRecord $record, array $attributes, ?User $user, ?string $sourceLabel = null): void
    {
     ...
     */
    public function logUpdated(Entity $entity, EntityRecord $record, array $original, array $updated, ?User $user, ?string $sourceLabel = null): void
    {
        $transactionId = (string) Str::uuid();
