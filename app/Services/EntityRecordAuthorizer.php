...
class EntityRecordAuthorizer
{
     ...
     */
    public function levelFor(User $user, Entity $entity): EntityVisibilityLevel
    {
        $roles = $user->getRoles();
    ...
    public function canView(User $user, Entity $entity, int $ownerId): bool
    {
    ...
    public function canEdit(User $user, Entity $entity, int $ownerId): bool
    {
        return match ($this->levelFor($user, $entity)) {
    ...
    public function canDelete(User $user, Entity $entity, int $ownerId): bool
    {
        return match ($this->levelFor($user, $entity)) {
     ...
     */
    public function scopeQuery(Builder $query, User $user, Entity $entity): Builder
    {
