...
use App\Http\Requests\Admin\PreviewImporterRequest;
use App\Http\Requests\Admin\StoreImporterRequest;
use App\Http\Requests\Admin\UpdateImporterRequest;
use App\Jobs\RunImporterJob;
use App\Models\Entity;
use App\Models\Importer;
use App\Models\ImporterRun;
use App\Services\Importers\ImporterChannelFactory;
...
class ImporterController extends Controller
{
    ...
    {
        return view('admin.importers.create', $this->formData());
    }
    ...
    {
        return view('admin.importers.edit', $this->formData() + ['importer' => $importer]);
    }
    ...
    {
        return view('admin.importers.show', ['importer' => $importer]);
    }
