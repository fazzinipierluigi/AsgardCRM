...
use App\Http\Requests\Admin\ImportEntityRequest;
...
use App\Services\EntitySchemaTransfer;
...
class EntityController extends Controller
{
    ...
    {
        return view('admin.entities.edit', ['entity' => $entity]);
    }
    ...
    {
        return view('admin.entities.import');
    }
