...
use App\Http\Requests\Admin\UpdateDocumentStorageRequest;
 ...
 * (App\Http\Controllers\DocumentController) stores files on. Same
 * "blank secret on edit keeps the previous value" trick as
 * ConnectorController — see App\Services\DocumentStorageDiskResolver
...
class DocumentStorageController extends Controller
{
    ...
    {
        return view('admin.document-storage.edit', ['setting' => DocumentStorageSetting::current()]);
    }
