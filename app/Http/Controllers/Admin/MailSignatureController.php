...
use App\Http\Requests\Admin\StoreMailSignatureRequest;
use App\Http\Requests\Admin\UpdateMailSignatureRequest;
...
class MailSignatureController extends Controller
{
    ...
    {
        return view('admin.mail-signatures.index');
    }
    ...
    {
        return view('admin.mail-signatures.create');
    }
    ...
    {
        return view('admin.mail-signatures.edit', ['signature' => $mailSignature]);
    }
