...
use App\Http\Requests\Admin\StoreLoginProviderRequest;
use App\Http\Requests\Admin\UpdateLoginProviderRequest;
...
class LoginProviderController extends Controller
{
    ...
    {
        return view('admin.login-providers.index');
    }
    ...
    {
        return view('admin.login-providers.create');
    }
    ...
    public function edit(LoginProvider $loginProvider): View|RedirectResponse
    {
        ...
        return view('admin.login-providers.edit', ['loginProvider' => $loginProvider]);
    }
