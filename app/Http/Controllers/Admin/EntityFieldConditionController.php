...
use App\Http\Requests\Admin\EntityFieldConditionRequest;
 ...
 * App\Models\EntityFieldCondition) — each rule's targets are always
...
class EntityFieldConditionController extends Controller
{
    ...
    {
        return view('admin.entities.conditions.index', [
            'entity' => $entity,
    ...
    {
        return view('admin.entities.conditions.form', $this->formData($entity));
    }
    ...
    public function edit(Entity $entity, EntityFieldCondition $condition): View
    {
        ...
        return view('admin.entities.conditions.form', [
