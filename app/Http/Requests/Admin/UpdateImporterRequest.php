...
/**
 * The importer's entity and channel are immutable after creation, same
 * as Connector's type — the edit form carries them via hidden inputs so
 * required_if rules still discriminate correctly, but the controller
 * always persists the entity_id/channel already stored on the model.
 */
class UpdateImporterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Blank keeps the previously stored secret — see ImporterController::update().
