...
- `resources/views/layouts/admin.blade.php` (`@extends('layouts.app')`) — Utenti / Ruoli links + "back to dashboard" link. No standalone "Permessi" menu entry/page — see "admin CRUD" below.
