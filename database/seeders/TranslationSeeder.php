...
class TranslationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $strings = [
            ...
            'Classe icona Tabler mostrata nel menu, es. "ti ti-users".' => [
                'it' => 'Classe icona Tabler mostrata nel menu, es. "ti ti-users".',
                'en' => 'Tabler icon class shown in the menu, e.g. "ti ti-users".',
            ],
