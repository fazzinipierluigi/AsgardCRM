        ...
        <div class="card-body">
            ...
            <div class="fields-container row g-2">
                @foreach ($fields as $field)
                    @include('crm::admin.entities._field', ['tabToken' => $tabToken, 'cardToken' => $cardToken, 'fieldToken' => $field->id, 'field' => $field, 'relationTargets' => $relationTargets, 'fieldTypes' => $fieldTypes, 'entity' => $entity])
                @endforeach
            </div>
        </div>
    </div>
