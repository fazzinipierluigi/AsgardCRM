...
/**
 * The connector's type is immutable after creation, same as
 * LoginProvider — the edit form carries it via a hidden input so
 * required_if rules still discriminate correctly, but the controller
 * always persists the type already stored on the model.
 */
class UpdateConnectorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Blank keeps the previously stored secret — see ConnectorController::update().
