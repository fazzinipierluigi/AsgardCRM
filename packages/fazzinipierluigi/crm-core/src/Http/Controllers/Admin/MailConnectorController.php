...
class MailConnectorController extends Controller
{
    ...
    {
        return view('crm::admin.mail-connectors.index');
    }
    ...
    {
        return view('crm::admin.mail-connectors.create');
    }
    ...
    {
        return view('crm::admin.mail-connectors.edit', ['connector' => $mailConnector]);
    }
